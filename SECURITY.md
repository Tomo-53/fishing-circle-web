...
MAIL_PASSWORD=abcd efgh ijkl mnop  # ← 16文字のApp Password
...
- **緊急事態**: セキュリティインシデントの場合は即座にIssueを作成
- **質問**: セキュリティ設定に関する質問は GitHub Discussions へ
- **改善提案**: よりセキュアな実装方法があれば Pull Request 歓迎
...
このガイドを通じて、安全で実用的な Web アプリケーション開発を実現しましょう。
